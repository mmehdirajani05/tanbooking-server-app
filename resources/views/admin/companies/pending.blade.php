...
@section('page-title', 'Pending Company Approvals')
@section('pageSubTitle', 'Review and approve company registration applications')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {{ $company->documents_count }} documents
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('admin.companies.show', $company->id) }}" class="text-primary-600 hover:text-primary-900 mr-3">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">No Pending Companies</h3>
            <p class="text-gray-500">All company applications have been reviewed.</p>
        </div>
    @endif
</div>
@endsection